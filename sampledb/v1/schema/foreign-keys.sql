...
ALTER TABLE dms_sample.sporting_event_ticket
ADD CONSTRAINT set_seat_fk_1013578649 FOREIGN KEY (sport_location_id, seat_level, seat_section, seat_row, seat) 
...
ALTER TABLE dms_sample.sporting_event_ticket
ADD CONSTRAINT set_sporting_event_fk_981578535 FOREIGN KEY (sporting_event_id) 
